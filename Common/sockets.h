...
struct CROSEServerConfig
{
    ...
    UINT VisualDelay;
    UINT WorldDelay;
	UINT DeathDelay;				 // Death Delay - Ported from PY - Terr0risT
    ...
    int LottoType;
    bool LottoActive;
    unsigned long long ZulieCost;
    unsigned int Command_Lotto;
    unsigned long long ZuliePrize;
    unsigned long long ZulieLimit;
