...
void CMonster::SpawnMonster( CPlayer* player, CMonster* thismon )
{
	...
	if(thismon->owner != player->clientid)
    {
        ...
        else
        {
            ...
            {
                //Friendly
                //ADDDWORD ( pak, 2 ); // Previous code commented out - Terr0risT
                ADDDWORD ( pak, 0x00000000 );  // New code so summons are friendly in friendly maps.
            }
            else
            {
                //Hostil
        ...
        //Friendly
        //ADDDWORD( pak, 2 );
        ADDDWORD ( pak, 0x00000000 );  // New code so summons are friendly in friendly maps. Terr0risT
    }
