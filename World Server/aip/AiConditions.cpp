...
AICOND(030)
{
    ...
    {
        //thisMonster->life_time=data->Timer; // Terr0risT adds 300 to increase Bonfire life.
        thisMonster->life_time = 600; // Terr0risT adds 300 to increase Bonfire life.
        //Log(MSG_INFO,"Setting life time for SUMMON %i to %u",thisMonster->montype,thisMonster->life_time);
    }
