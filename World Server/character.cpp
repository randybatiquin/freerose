...
//    Stats->ShieldDamage = 0;
    ...
    //LMA: pvp status.
    pvp_status=-1; // Terr0risT PVP test. Original value is -1
    ...
    ClearBattle( Battle );
    Battle->castTime = 0;
    Battle->lastcastspeed = 0;
    Battle->lastAtkTime = 0;
    Battle->lastatktype = 0;
    //STATUS
    Status = new STATUS;
    assert(Status);
