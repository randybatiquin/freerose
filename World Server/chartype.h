...
struct STATS
{
    ...
    */
    ...
    unsigned int Base_Attack_Speed;
...
struct BATTLE
{
    ...
    unsigned int hitby;
    unsigned int lastcastspeed;
    unsigned int lastatktype;
    bool contatk;
    clock_t lastAtkTime;
    clock_t castTime;
};
