...
class CPlayer: public CCharacter
{
   ...
   //LMA: last shout.
    ...
    void AttrGMGear();   //rl: Add GM Gear
	...
	void UpdateCostume( unsigned int slot1, unsigned int slot2=0xffff, bool save=true);
	void UpdateInventoryNoSave( unsigned int slot1, unsigned int slot2=0xffff );
    ...
    void Send_pakQuestReply(int result, int slot,  int unk1, int quest);
    // Player Stats
    ...
    unsigned int GetSen( );
    unsigned int GetCon( );
    unsigned int GetClassRequiredStatus( );
