...
class CMap
{
    ...
    CMonster* AddAdrenaMonster( UINT montype, fPoint position, int team );
    CMonster* AddNpc( UINT montype, fPoint position, int team);
    ...
    void RespawnMonster( );
    bool IsNight( );
    void UpdateArena ( CPlayer* thisclient );
    //LMA: nb_summons
    UINT nb_summons;
