...
void CWorldServer::LoadConfigurations( const char* file )
{
	...
	Config.WorldIP              = ConfigGetString ( file, "serverip", "209.141.43.6" );
	...
	Config.WELCOME_MSG          = ConfigGetString ( file, "welcome_msg", "Welcome to FableRose Online" );

    //Log (MSG_INFO, "iRose Online - http://www.iroseonline.com");
    //Log (MSG_INFO, "RoseZA Online - http://www.roseza.co.za");
...
void CWorldServer::LoadCommandLevels( void )
{
    ...
    Config.Command_GMGear = ConfigGetInt ( "commands.ini", "gmgear", 299 );
    ...
    Config.Command_freeroseBuff = ConfigGetInt    ( "commands.ini", "freerosebuff", 299 );
    ...
    Config.Command_freeroseTime  = ConfigGetInt    ( "commands.ini", "freerosedelay", 60 );
    ...
    //Donation Points
    Config.AutoDP = ConfigGetInt ( "commands.ini", "AutoDP", 1);
...
bool CWorldServer::OnReceivePacket( CClientSocket* thisclient, CPacket *P )
{
	switch( P->Command )
	{
        case 0x500: return pakCSReady          ( (CPlayer*)thisclient->player, P );
        case 0x502: return pakCharDSClient     ( (CPlayer*)thisclient->player, P );
    	case 0x505: return pakCSCharSelect     ( (CPlayer*)thisclient->player, P );

        case 0x700: return pakPing             ( (CPlayer*)thisclient->player, P );
    	case 0x707: return pakExit             ( (CPlayer*)thisclient->player, P );
    	case 0x70b: return pakDoIdentify       ( (CPlayer*)thisclient->player, P );

    	case 0x71c: return pakCharSelect       ( (CPlayer*)thisclient->player, P );

        case 0x727: return pakItemmallBuy      ( (CPlayer*)thisclient->player, P );

    	case 0x730: return pakQuestReq         ( (CPlayer*)thisclient->player, P );
    	case 0x731: return pakQuestTrigger     ( (CPlayer*)thisclient->player); //Ifo quest trigger
    	case 0x753: return pakDoID             ( (CPlayer*)thisclient->player, P );
    	case 0x755: return pakUserDied         ( (CPlayer*)thisclient->player, P );
    	case 0x756: return pakChangeRespawn    ( (CPlayer*)thisclient->player, P );

    	case 0x762: return pakWeight           ( (CPlayer*)thisclient->player, P );

    	case 0x771: return pakStopChar         ( (CPlayer*)thisclient->player, P );

    	case 0x781: return pakDoEmote          ( (CPlayer*)thisclient->player, P );
    	case 0x782: return pakChangeStance     ( (CPlayer*)thisclient->player, P );
    	case 0x783: return pakNormalChat       ( (CPlayer*)thisclient->player, P );
    	case 0x784: return pakWhisper          ( (CPlayer*)thisclient->player, P );
    	case 0x785: return pakShout            ( (CPlayer*)thisclient->player, P );
    	case 0x786: return pakPartyChat        ( (CPlayer*)thisclient->player, P );
    	case 0x788: return true;
    	case 0x789: return pakChatUnion        ( (CPlayer*)thisclient->player, P );

    	case 0x796: return pakPvp796           ( (CPlayer*)thisclient->player, P );
    	case 0x798: return pakStartAttack      ( (CPlayer*)thisclient->player, P );
    	case 0x79a: return pakMoveChar         ( (CPlayer*)thisclient->player, P );
      	case 0x79f: return pakShowHeal         ( (CPlayer*)thisclient->player, P );

    	case 0x7a1: return pakNPCBuy           ( (CPlayer*)thisclient->player, P );
        case 0x7a3: return pakUseItem          ( (CPlayer*)thisclient->player, P );
        case 0x7a4: return pakDoDrop           ( (CPlayer*)thisclient->player, P );
        case 0x7a5: return pakChangeEquip      ( (CPlayer*)thisclient->player, P );
    	case 0x7a7: return pakPickDrop         ( (CPlayer*)thisclient->player, P );
    	case 0x7a8: return pakGate             ( (CPlayer*)thisclient->player, P );
    	case 0x7a9: return pakAddStats         ( (CPlayer*)thisclient->player, P );
    	case 0x7aa: return pakMoveSkill        ( (CPlayer*)thisclient->player, P );
    	case 0x7ab: return pakEquipABC         ( (CPlayer*)thisclient->player, P );
    	case 0x7ad: return pakStorage          ( (CPlayer*)thisclient->player, P );
    	case 0x7af: return pakCraft            ( (CPlayer*)thisclient->player, P );

        case 0x7b0: return pakLearnSkill ((CPlayer*)thisclient->player, P );
        case 0x7b1: return pakLevelUpSkill     ( (CPlayer*)thisclient->player, P );
        case 0x7b2: return pakSkillSelf        ( (CPlayer*)thisclient->player, P );
    	case 0x7b3: return pakStartSkill       ( (CPlayer*)thisclient->player, P );
    	case 0x7b4: return pakSkillAOE         ( (CPlayer*)thisclient->player, P );
		case 0x7ba: return pakidentify         ( (CPlayer*)thisclient->player, P );
    	case 0x7bc: return pakModifiedItem     ( (CPlayer*)thisclient->player, P );
    	case 0x7be: return pakItemMallList     ( (CPlayer*)thisclient->player, P );
    	case 0x7bf: return pakAddWishList      ( (CPlayer*)thisclient->player, P );

    	case 0x7c0: return pakTradeAction      ( (CPlayer*)thisclient->player, P );
    	case 0x7c1: return pakTradeAddItem     ( (CPlayer*)thisclient->player, P );
    	case 0x7c2: return pakOpenShop         ( (CPlayer*)thisclient->player, P );
    	case 0x7c3: return pakCloseShop        ( (CPlayer*)thisclient->player, P );
        case 0x7c4: return pakShowShop         ( (CPlayer*)thisclient->player, P );
        case 0x7c5: return pakBuyShop          ( (CPlayer*)thisclient->player, P );
        case 0x7c6: return pakSellShop         ( (CPlayer*)thisclient->player, P );
        case 0x7c8: return pakChangeStorage    ( (CPlayer*)thisclient->player, P );
        case 0x7c9: return pakChangeItemMallPoints   ( (CPlayer*)thisclient->player, P );
    	case 0x7ca: return pakChangeCart       ( (CPlayer*)thisclient->player, P );
    	case 0x7cb: return pakRepairItem       ( (CPlayer*)thisclient->player, P,2);
    	case 0x7cd: return pakRepairItem       ( (CPlayer*)thisclient->player, P,1);
		case 0x7cf: return pakChangeCostume    ( (CPlayer*)thisclient->player, P );

    	case 0x7d0: return pakPartyActions     ( (CPlayer*)thisclient->player, P );
    	case 0x7d1: return pakPartyManager     ( (CPlayer*)thisclient->player, P );
    	case 0x7d7: return pakPartyOption      ( (CPlayer*)thisclient->player, P );
    	case 0x7d8: return pakModifiedItemDone ( (CPlayer*)thisclient->player, P );
        case 0x7d9: return pakItemMall         ( (CPlayer*)thisclient->player, P );
    	case 0x7da: return pakStoreZuly        ( (CPlayer*)thisclient->player, P );
    	case 0x7dd: return pakRideRequest      ( (CPlayer*)thisclient->player, P );

    	case 0x7e0: return pakCreateClan       ( (CPlayer*)thisclient->player, P );
    	case 0x7e1: return pakClanManager      ( (CPlayer*)thisclient->player, P );
    	case 0x7eb: return pakPrintscreen      ( (CPlayer*)thisclient->player, P );
    	case 0x7ed: return pakChatTrade        ( (CPlayer*)thisclient->player, P );
    	case 0x7ee: return pakLuckySpinList    ( (CPlayer*)thisclient->player, P ); // Observe: Items List - Lucky Spin
    	case 0x7ef: return pakLuckySpinShuffle ( (CPlayer*)thisclient->player, P ); // Observe: Shuffle Items - Lucky Spin

    	case 0x7f0: return pakLuckySpinBuy     ( (CPlayer*)thisclient->player, P ); // Observe: Buy Spins - Lucky Spin
    	case 0x7f1: return pakSpinWheel        ( (CPlayer*)thisclient->player, P ); // Observe: Spin Wheel
    	case 0x7f2: return pakLuckySpin        ( (CPlayer*)thisclient->player, P ); // Observe: Initial Wheel
    	case 0x7f3: return true; // Buy spins with coins!
    	case 0x7fb: return pakTradeAddZulie    ( (CPlayer*)thisclient->player, P );

    	case 0x808: return pakGameGuard        ( (CPlayer*)thisclient->player, P );
    	case 0x819: return pakPremiumRedeem    ( (CPlayer*)thisclient->player, P );
    	case 0x821: return pakExpTC            ( (CPlayer*)thisclient->player, P );

    	case 0x830: return pakGameListReq      ( (CPlayer*)thisclient->player, P );
    	case 0x831: return pakQueueJoin        ( (CPlayer*)thisclient->player, P );
    	case 0x832: return pakQueueLeave       ( (CPlayer*)thisclient->player, P );
    	case 0x833: return pakJoinArena        ( (CPlayer*)thisclient->player, P );

    	case 0x850: return pakGroup            ( (CPlayer*)thisclient->player, P );
    	case 0x852: return pakGroupActions     ( (CPlayer*)thisclient->player, P );
    	case 0x853: return Recv_pakGroupMemberList ( (CPlayer*)thisclient->player, P );

        case 0x860: return pakSendGroupID      ( (CPlayer*)thisclient->player, P ); //send groupid if char changes map maybe more is sended

    	case 0x859: return pakMount            ( (CPlayer*)thisclient->player, P ); // Observe: Mount

    	//Quest trigger activated

    	default:
    		Log( MSG_WARNING, "Unknown packet <%04x::%i>",P->Command, P->Size - 6);
		break;
	}
	return true;
}
...
void BanTracker()
{
    ...
    if(row == NULL){
        ...
        // Terr0risT - Turning off this log.
        GServer->DB->QFree();
        return;
    }
}
...
void LoadLottoConfig()
{
    ...
    res = GServer->DB->QStore("SELECT accesslevel,active,type,ZulieCost,ZulieLimit FROM lotto_config WHERE id='1'");
    if(res == NULL) return;


        row = mysql_fetch_row(res);

        //GServer->Config.Command_Lotto = atoi(row[0]);
        GServer->Config.LottoActive = atoi(row[1])?true:false;
        GServer->Config.LottoType = atoi(row[2]);
        GServer->Config.ZulieCost = atoi(row[3]);
        GServer->Config.ZulieLimit = atoll(row[4]);

        GServer->DB->QFree();
    /*}    {
        GServer->Config.Command_Lotto = 299;
        GServer->Config.LottoActive = false;
